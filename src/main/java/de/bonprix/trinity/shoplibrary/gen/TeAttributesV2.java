 ...
 * This Class uses a Builder Pattern - use TeAttributesV2.builder() to create a Builder
...
@Builder
@ToString
public class TeAttributesV2 extends AbstractAttributes {

	@JsonIgnore
	private transient final Schema schema = new Schema("TE", 2L);
	...
	*/
    ...
    /**
     * <br>
     * aa is not Mandatory  <br>
     * asd is not Mandatory  <br>
	*/
	public static TeAttributesV2Builder builder() {
		return new TeAttributesV2.CustomAttributesBuilder();
	}

	/**
	 * Custom  builder class
	 */
	private static class CustomAttributesBuilder extends TeAttributesV2Builder {

		@Override
		public TeAttributesV2 build() {
