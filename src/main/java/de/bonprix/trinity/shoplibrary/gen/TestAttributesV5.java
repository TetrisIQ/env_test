 ...
 * This Class uses a Builder Pattern - use TestAttributesV5.builder() to create a Builder
...
@Builder
@ToString
public class TestAttributesV5 extends AbstractAttributes {

	@JsonIgnore
	private transient final Schema schema = new Schema("TEST", 5L);
	...
	*/
	public static TestAttributesV5Builder builder() {
		return new TestAttributesV5.CustomAttributesBuilder();
	}

	/**
	 * Custom  builder class
	 */
	private static class CustomAttributesBuilder extends TestAttributesV5Builder {

		@Override
		public TestAttributesV5 build() {
