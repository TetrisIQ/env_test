 ...
 * This Class uses a Builder Pattern - use TerAttributesV1.builder() to create a Builder
...
@Builder
@ToString
public class TerAttributesV1 extends AbstractAttributes {

	@JsonIgnore
	private transient final Schema schema = new Schema("TER", 1L);
	...
	*/
     ...
     * <br>
	*/
	public static TerAttributesV1Builder builder() {
		return new TerAttributesV1.CustomAttributesBuilder();
	}

	/**
	 * Custom  builder class
	 */
	private static class CustomAttributesBuilder extends TerAttributesV1Builder {

		@Override
		public TerAttributesV1 build() {
