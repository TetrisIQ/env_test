 ...
 * This Class uses a Builder Pattern - use TerAttributesV3.builder() to create a Builder
...
@Builder
@ToString
public class TerAttributesV3 extends AbstractAttributes {

	@JsonIgnore
	private transient final Schema schema = new Schema("TER", 3L);
   ...
   */
	...
	*/
	public static TerAttributesV3Builder builder() {
		return new TerAttributesV3.CustomAttributesBuilder();
	}

	/**
	 * Custom  builder class
	 */
	private static class CustomAttributesBuilder extends TerAttributesV3Builder {

		@Override
		public TerAttributesV3 build() {
