 ...
 * This Class uses a Builder Pattern - use TeAttributesV1.builder() to create a Builder
...
@Builder
@ToString
public class TeAttributesV1 extends AbstractAttributes {

	@JsonIgnore
	private transient final Schema schema = new Schema("TE", 1L);
	...
	*/
	public static TeAttributesV1Builder builder() {
		return new TeAttributesV1.CustomAttributesBuilder();
	}

	/**
	 * Custom  builder class
	 */
	private static class CustomAttributesBuilder extends TeAttributesV1Builder {

		@Override
		public TeAttributesV1 build() {
