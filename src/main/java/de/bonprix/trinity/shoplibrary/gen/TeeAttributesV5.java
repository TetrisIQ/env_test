 ...
 * This Class uses a Builder Pattern - use TeeAttributesV5.builder() to create a Builder
...
@Builder
@ToString
public class TeeAttributesV5 extends AbstractAttributes {

	@JsonIgnore
	private transient final Schema schema = new Schema("TEE", 5L);
   ...
   */
	...
	*/
	public static TeeAttributesV5Builder builder() {
		return new TeeAttributesV5.CustomAttributesBuilder();
	}

	/**
	 * Custom  builder class
	 */
	private static class CustomAttributesBuilder extends TeeAttributesV5Builder {

		@Override
		public TeeAttributesV5 build() {
