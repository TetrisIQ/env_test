 ...
 * This Class uses a Builder Pattern - use TeeAttributesV1.builder() to create a Builder
...
@Builder
@ToString
public class TeeAttributesV1 extends AbstractAttributes {

	@JsonIgnore
	private transient final Schema schema = new Schema("TEE", 1L);
	...
	*/
	public static TeeAttributesV1Builder builder() {
		return new TeeAttributesV1.CustomAttributesBuilder();
	}

	/**
	 * Custom  builder class
	 */
	private static class CustomAttributesBuilder extends TeeAttributesV1Builder {

		@Override
		public TeeAttributesV1 build() {
