 ...
 * This Class uses a Builder Pattern - use TeeAttributesV3.builder() to create a Builder
...
@Builder
@ToString
public class TeeAttributesV3 extends AbstractAttributes {

	@JsonIgnore
	private transient final Schema schema = new Schema("TEE", 3L);
   ...
   */
	...
	*/
	public static TeeAttributesV3Builder builder() {
		return new TeeAttributesV3.CustomAttributesBuilder();
	}

	/**
	 * Custom  builder class
	 */
	private static class CustomAttributesBuilder extends TeeAttributesV3Builder {

		@Override
		public TeeAttributesV3 build() {
